...
when calling MCP from an agent bridge. See [AGENTS.md](https://github.com/debian777/kairos-mcp/blob/main/AGENTS.md).
...
The repository [README](https://github.com/debian777/kairos-mcp/blob/main/README.md) summarizes the same paths.
...
[authentication overview](https://github.com/debian777/kairos-mcp/blob/main/docs/architecture/auth-overview.md).
