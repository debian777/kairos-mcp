...
# ELITE AI CODING STANDARDS

Every code change MUST follow CHECK LOCAL DOCUMENTATION FOR BUILD, DEPLOY, AND TEST (foundational rule) and then sections 0–10 in exact order. Deviation = automatic failure rating on the entire chain.

## Natural Language Triggers

Run when the user says "/code", "AI coding rules", or "coding rules".
