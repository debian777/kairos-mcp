...
# so replace npm's bundled copy with 5.0.9 (CVE-2026-14257, CVE-2026-69152) until an npm release bundles it.
RUN npm install -g npm@11.18.0 && \
    cd /tmp && npm pack brace-expansion@5.0.9 --silent && \
    ...
    rm brace-expansion-5.0.9.tgz && cd /
