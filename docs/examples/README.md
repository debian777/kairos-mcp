...
- **Imports:** Mint each mintable example via `kairos_mint` (e.g. from integration tests or an agent). See [skills/.system/kairos-development/](../../skills/.system/kairos-development/) (workflow-test, ai-mcp-integration) and [Workflow test README](../../tests/workflow-test/README.md).
...
- [skills/.system/kairos-development/](../../skills/.system/kairos-development/) — Agent instructions for kairos-dev (workflow-test, ai-mcp-integration). [Workflow test README](../../tests/workflow-test/README.md) — Test harness and how to run.
