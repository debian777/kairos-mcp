...
- `activate` — user discovery (Natural Language Triggers) and runtime type-dispatch where the target depends on a runtime variable (e.g., `activate("Standardize {project_type}")`).
