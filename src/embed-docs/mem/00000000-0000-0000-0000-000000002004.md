...
**Phase-batch with critic** — batch TODO items into a phase, then fire the `phase-critic` meta-protocol (`kairos_begin(key: "phase-critic")`) to adversarially validate all outputs at once:
