...
export function ProtocolEditPage() {
  ...
  return (
    <div>
      ...
      <div className="mb-6 flex flex-wrap items-center justify-between gap-3 rounded-[var(--radius-md)] border border-[var(--color-border)] bg-[var(--color-surface-elevated)] p-4">
        <div>
      ...
      <form onSubmit={handleSubmit} aria-label={t("protocolEdit.formLabel")}>
        <div className="mb-6 grid gap-4 xl:grid-cols-[1.45fr_1fr]">
            ...
            {form.steps.map((step, index) => (
              ...
              >
                <div className="mb-4 flex flex-wrap items-center justify-between gap-2">
                  <div className="text-sm font-medium text-[var(--color-text-heading)]">Step {index + 1}</div>
                  <button
                    type="button"
