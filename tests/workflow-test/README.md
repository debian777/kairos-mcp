...
**Canonical agent instructions** (prompt and constraints) are in [skills/.system/kairos-development/workflow-test.md](../../skills/.system/kairos-development/workflow-test.md). The prompt below is a copy for the test harness; use the skill for a single source of truth.
...
Use the prompt in [PROMPT.md](PROMPT.md) (or [skills/.system/kairos-development/workflow-test.md](../../skills/.system/kairos-development/workflow-test.md)) when running these tests. It enforces:
