 ...
 * by calling spaces and asserting the Kairos app space (kairos_dev) has at least 2 chains
...
describe('Mem boot injection', () => {
  ...
  test('spaces shows Kairos app space with at least 2 chains (mint at boot)', async () => {
