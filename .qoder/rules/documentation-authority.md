...
| Agent operation, execution model, maintainer workflows | Skills (`skills/`, `.agents/skills/`) + `AGENTS.md` | Human/AI |
| Test fixtures, install-skill reference sources | `docs/examples/`, `docs/install/`, `docs/CLI.md` (functional inputs, not prose docs) | Tied to code/tests |
...
Generated READMEs (e.g. `skills/.system/kairos-install/references/**`) are never
hand-edited.
...
- `.agents/skills/kmcp-dev-doc-governance/SKILL.md` audits and auto-repairs
  drift, and hands wiki regeneration to Qoder + `kmcp-dev-repowiki-sync`.
